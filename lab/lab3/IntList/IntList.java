...
public class IntList {
    ...
    public static IntList reverse(IntList A) {
         ...
         *
         *   case1: only one element, return.
         *   case2: reverse all the elements.
         *
         * */
     ...
     *  If given null as an input, returns null.
     */
    public IntList dereverse() {

        // one element and input is null
        if (this.rest == null) {
            return this;
        }

        IntList tmp = this.rest;
        this.rest = null;

        while (tmp != null) {

            // create new IntList, do not try to `IntList tmp2 = this;`
            IntList tmp2 = new IntList(this.first, this.rest);
